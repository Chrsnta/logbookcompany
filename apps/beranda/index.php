...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <!-- Info Aplikasi -->
            <p>Selamat Datang di Aplikasi Kegiatan Harian Karyawan berbasis Web. Sebuah sistem yang memungkinkan para Karyawan di <?php echo $row['nama_instansi'];?> untuk mencatat kegiatan harian dari website. Sistem ini diharapkan dapat memberi kemudahan setiap Karyawan untuk mencatat kegiatan harian.</p>
            <!-- Info Aplikasi -->

...
<nav class="navbar navbar-custom navbar-fixed-top bg-info" role="navigation">
    <div class="container-fluid"><!-- container-fluid -->
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">KEGIATAN HARIAN</a>
        </div>
    </div><!-- /.container-fluid -->
</nav>
    ...
    <?php if ($_SESSION['level']=='Mahasiswa' or $_SESSION['level']=='mahasiswa'):?>
        <div class="profile-sidebar">
            ...
            <?php echo substr($_SESSION['nama_mahasiswa'],0,20); ?>
                <div class="profile-usertitle-name"><?php echo "Karyawan"; ?></div>
                <div></div>
            </div>
            <div class="clear"></div>
        </div>
...
<div class="divider"></div>
    ...
    <!-- Menu Admin -->
        <?php if ($_SESSION["level"]=="Admin" or $_SESSION['level']=='admin'): ?>
            <li><a href="index.php?page=mahasiswa" id="mahasiswa"><em class="fa fa-users">&nbsp;</em> Data Karyawan</a></li>
